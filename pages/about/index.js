      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <motion.h2
            ...
            className="h2"
          >
            Building a <span className="text-[#003a6a]">Future</span> of Smart
            Solutions.
          </motion.h2>
          <motion.p
          ...
          >
            We began our journey with a vision to build smart, innovative
            solutions. Since our inception, we’ve worked with businesses and
            startups to craft tailored digital products that transform ideas
